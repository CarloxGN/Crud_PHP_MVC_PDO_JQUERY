...
include_once 'class/Counties.class.php';
include_once 'class/Sectors.class.php';
...
class controllerCounties {
	...
	public function listCountiesState($state) {
		$this->county->set('id_state', $state);
		$data = $this->county->get_counties_state();
		return $data;
	}
}

class controllerSectors {
	private $sector;
	...
	public function listSectorsCounty($county) {
		$this->sector->set('id_county', $county);
		$data = $this->sector->get_sectors_county();
		return $data;
	}
